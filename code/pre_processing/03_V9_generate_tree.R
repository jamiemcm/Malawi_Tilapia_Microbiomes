...
# script 'V9_DADA2_generate_ASV_table.R', and removal of likely contaminants
# with the decontam package, in script 'V9_decontam_remove_contaminants.R'
...
ps <- readRDS("/gpfs/ts0/projects/Research_Project-164554/Dominique/V9_phyloseq_obj_after_organelle_removal.rds")
...
saveRDS(dm, "/gpfs/ts0/projects/Research_Project-164554/Dominique/V9.phang.ml.dist.rds")
...
saveRDS(ps.merged, "/gpfs/ts0/projects/Research_Project-164554/Dominique/V9_phyloseq_obj_with_tree.rds")